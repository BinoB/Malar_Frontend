...
export const createNewProduct  =  productData => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.post(`${URL}/api/v1/admin/product/new`, productData);
...
export const deleteProduct  =  id => async (dispatch) => {
    ...
    try {  
        ...
        await axios.delete(`${URL}/api/v1/admin/product/${id}`);
...
export const updateProduct  =  (id, productData) => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.put(`${URL}/api/v1/admin/product/${id}`, productData);
...
export const getReviews =  id => async (dispatch) => {
    ...
    try {  
        ...
        const { data }  =  await axios.get(`${URL}/api/v1/admin/reviews`,{params: {id}});
...
export const deleteReview =  (productId, id) => async (dispatch) => {
    ...
    try {  
        ...
        await axios.delete(`${URL}/api/v1/admin/review`,{params: {productId, id}});
